...
func (uc *UserCreate) SetUserCreated(t time.Time) *UserCreate {
	uc.mutation.SetUserCreated(t)
	return uc
}

// SetNillableUserCreated sets the "user_created" field if the given value is not nil.
func (uc *UserCreate) SetNillableUserCreated(t *time.Time) *UserCreate {
	if t != nil {
		uc.SetUserCreated(*t)
	}
	return uc
...
func (uc *UserCreate) defaults() {
	...
	if _, ok := uc.mutation.UserCreated(); !ok {
		v := user.DefaultUserCreated()
		uc.mutation.SetUserCreated(v)
	}
}
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if value, ok := uc.mutation.UserCreated(); ok {
