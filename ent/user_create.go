...
func (_c *UserCreate) SetUserUUID(v uuid.UUID) *UserCreate {
	_c.mutation.SetUserUUID(v)
	return _c
}

// SetNillableUserUUID sets the "user_uuid" field if the given value is not nil.
func (_c *UserCreate) SetNillableUserUUID(v *uuid.UUID) *UserCreate {
	if v != nil {
		_c.SetUserUUID(*v)
	}
	return _c
...
func (_c *UserCreate) SetUserCreated(v time.Time) *UserCreate {
	_c.mutation.SetUserCreated(v)
	return _c
}

// SetNillableUserCreated sets the "user_created" field if the given value is not nil.
func (_c *UserCreate) SetNillableUserCreated(v *time.Time) *UserCreate {
	if v != nil {
		_c.SetUserCreated(*v)
	}
	return _c
...
func (_c *UserCreate) defaults() {
	...
	if _, ok := _c.mutation.UserCreated(); !ok {
		v := user.DefaultUserCreated()
		_c.mutation.SetUserCreated(v)
	}
}
...
func (_c *UserCreate) check() error {
	...
	if _, ok := _c.mutation.UserCreated(); !ok {
		return &ValidationError{Name: "user_created", err: errors.New(`ent: missing required field "User.user_created"`)}
	}
...
func (_c *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.UserCreated(); ok {
		_spec.SetField(user.FieldUserCreated, field.TypeTime, value)
		_node.UserCreated = value
	}
